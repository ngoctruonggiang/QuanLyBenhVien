...
const navItems = [
  { title: "Dashboard", href: "/nurse/dashboard", icon: Home },
  { title: "Hàng đợi", href: "/nurse/queue", icon: ClipboardList },
  { title: "Sinh hiệu", href: "/nurse/vital-signs", icon: Heart },
  { title: "Xét nghiệm", href: "/nurse/lab-results", icon: TestTube },
  { title: "Nhà thuốc", href: "/nurse/pharmacy", icon: Pill },
  { title: "Lịch làm việc", href: "/nurse/schedule", icon: Calendar },
];
          ...
          <header className="topnav">
            <div className="flex items-center gap-6">
              <h1 className="text-title">
                {navItems.find((item) => pathname.startsWith(item.href))?.title || "Y tá"}
              </h1>
            </div>
